...
label = Label(root, text="Assigning Jobs", font=("times",25,"bold"),fg="Deeppink2")

label.place(relx=0.01, rely=0.06,anchor=W)


#------------------Label for string Docter-------------
label_doctor=Label(root,text="Doctor : ",font=("times",18,"bold"))
label_doctor.place(relx= 0.04,rely=0.15,anchor=CENTER)
label_doctor.place()


#------------------Label for string IT professional-------------
label_IT=Label(root,text="IT professional : ",font=("times",18,"bold"))
label_IT.place(relx=0.06,rely= 0.45 ,anchor=CENTER)
label_IT.place()


#------------------Label for string "Chemical Engineer ------------
label_chemical=Label(root,text="Chemical Engineer : ",font=("times",18,"bold"))
label_chemical.place(relx=0.075,rely=0.75,anchor=CENTER)
